...
with open("/content/drive/MyDrive/pro_cnn_model.json",'w') as json_file:
    json_file.write(model_json)
model.save("/content/drive/MyDrive/pro_cnn_model.h5")
model.save("/content/drive/MyDrive/pro_cnn_model.keras")