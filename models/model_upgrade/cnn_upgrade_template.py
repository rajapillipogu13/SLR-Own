...
img = image.load_img("/content/split_dataset/train/A/1.jpg")
plt.imshow(img)
...
with open("/content/drive/MyDrive/Upgrade_Model/cnn_upgrade_model.json",'w') as json_file:
    json_file.write(model_json)
model.save("/content/drive/MyDrive/Upgrade_Model/cnn_upgrade_model.h5")
model.save("/content/drive/MyDrive/Upgrade_Model/cnn_upgrade_model.keras")

model.save("cnn_upgrade_model.keras")

model.save_weights("cnn_upgrade_model.weights.h5")

model.save("cnn_upgrade_model.h5")